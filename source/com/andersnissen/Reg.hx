...
class Reg
{
    ...
    public static var gameList :Array<Class<GameState>> = [BugSwatter, Flee, DrawLine, RobotVacuumCleaner, HexChain, Jump, MultiTouch, Bounce, Overlap, CollectDots /* Lasers, */ ];
}
